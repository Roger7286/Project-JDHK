...
main.py
=======
职责：分步调入单同步流程总入口，串联 API 拉取 → 数据库写入两个步骤。
...
执行方式：
    ...
    # 指定单据编号
    python main.py --billno "DBRK-260405-000001"
...
from fetch_transinbill          import fetch_all_pages
from load_transinbill_to_pg     import upsert_rows

# =========================================================
# 常量
# =========================================================

API_NAME    = "/v2/im/im_transinbill/getList"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="金蝶分步调入单 → PostgreSQL 增量/全量同步",
