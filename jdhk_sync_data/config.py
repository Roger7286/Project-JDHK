...
API_PATHS = {
    ...
    # 收料通知单查询
    "purreceivebill":   "/kapi/v2/im/im_purreceivebill/query",

    # 收料通知单列表查询
    "purreceivebillgetlist":   "/kapi/v2/im/im_purreceivebill/getList",

    #"purreceivebillgetlist":   "/kapi/v2/prod/im/im_purreceivebill/query",

    # 调拨申请单列表查询
    "transapply":              "/kapi/v2/im/im_transapply/getList",

    # 分步调出单列表查询
    "transoutbill":            "/kapi/v2/im/im_transoutbill/getList",

    # 分步调入单列表查询
    "transinbill":             "/kapi/v2/im/im_transinbill/getList",
