...
注意：
    - billentry 中的 billentry_lk（关联子实体）以 JSON 文本存入明细表 billentry_lk 字段
"""
...
def _entry_to_pg(entry: dict, bill_id) -> dict:
    ...
    return {
        ...
        # 关联子实体（JSON 序列化）
        "billentry_lk":           _json(g("billentry_lk")),
    }
